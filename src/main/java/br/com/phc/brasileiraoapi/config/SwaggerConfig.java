...
public class SwaggerConfig {
	...
	private static final String API_DESCRICAO = "API REST que obtem dados de partidas do Brasileirao em tempo real";
	private static final String API_VERSAO = "1.0.0";
	private static final String CONTATO_NOME = "Walison Martins";
	private static final String CONTATO_GITHUB = "https://github.com/Walisonx";
	private static final String CONTATO_EMAIL = "walisonmartins2009@hotmail.com";
